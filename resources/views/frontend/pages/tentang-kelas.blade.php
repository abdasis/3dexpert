        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-4">
                ...
                <a href="{{ route('kelas.rincian', ['kelas' => $kelas->nama_kelas, 'level' => 'Pemula']) }}">
                    <button class="btn  mb-2 btn-lg btn-block btn-outline-expert rounded-14 font-16 font-weight-bolder">Basic Class</button>
                </a>
                <a href="{{ route('kelas.rincian', ['kelas' => $kelas->nama_kelas, 'level' => 'Intermediate']) }}">
                    <button class="btn  mb-2 btn-lg btn-block btn-outline-expert rounded-14 font-16 font-weight-bolder">Intermediate Class</button>
                </a>
                <a href="{{ route('kelas.rincian', ['kelas' => $kelas->nama_kelas, 'level' => 'Expert']) }}">
                    <button class="btn  mb-2 btn-lg btn-block btn-outline-expert rounded-14 font-16 font-weight-bolder">Expert Class</button>
                </a>
            </div>
